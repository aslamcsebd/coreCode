   ...
   <nav id="navbar_top" class="navbar navbar-expand-md navbar-muted shadow-sm">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
         ...
         <ul class="navbar-nav mr-auto pushmenu">
            <a class="av-link hamburger sidebar-toggle" data-widget="pushmenu" href="#" role="button">
         ...
         @auth
            <ul class="navbar-nav all-item ml-auto">
               ...
               @endif
               <li class="nav-item">
                  <a class="nav-link btn btn-sm btn-outline-info" href="{{ url('viewCodeAll') }}">View All Code</a>
               </li>              
            </ul>
         @endauth
